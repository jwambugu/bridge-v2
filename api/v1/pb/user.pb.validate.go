...
func (m *KYCData) validate(all bool) error {
	...
	// no validation rules for KraPin
...
// Validate checks the field values on UserMeta with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on UserMeta with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in UserMetaMultiError, or nil
// if none found.
func (m *UserMeta) ValidateAll() error {
	return m.validate(true)
}

func (m *UserMeta) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, UserMetaValidationError{
					field:  "KycData",
		...
		if err := v.Validate(); err != nil {
			return UserMetaValidationError{
				field:  "KycData",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return UserMetaMultiError(errors)
	}

	return nil
}

// UserMetaMultiError is an error wrapping multiple validation errors returned
// by UserMeta.ValidateAll() if the designated constraints aren't met.
type UserMetaMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UserMetaMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UserMetaMultiError) AllErrors() []error { return m }

// UserMetaValidationError is the validation error returned by
// UserMeta.Validate if the designated constraints aren't met.
type UserMetaValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UserMetaValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UserMetaValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UserMetaValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UserMetaValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UserMetaValidationError) ErrorName() string { return "UserMetaValidationError" }

// Error satisfies the builtin error interface
func (e UserMetaValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = UserMetaValidationError{}
